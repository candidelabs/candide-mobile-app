...
class PaymasterContract extends _i1.GeneratedContract {
  ...
  /// set, the function will be evaluated in the specified block. By default, the
  /// latest on-chain block will be used.
  Future<BigInt> getDerivedValue(
    _i1.EthereumAddress _token,
    BigInt _ethBought, {
    _i1.BlockNum? atBlock,
  }) async {
    final function = self.abi.functions[8];
    assert(checkSignature(function, 'f882e5e0'));
    final params = [
      _token,
      _ethBought,
    ];
  ...
  Future<_i2.Uint8List> getHash(
    ...
    assert(checkSignature(function, 'ca250ddf'));
    final params = [
      userOp,
      paymasterData,
    ];
